    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('expenseCategory.name')->label(__('app.fields.category')),
                TextColumn::make('project.name')->label(__('app.fields.project'))->placeholder('—'),
                TextColumn::make('paymentMethod.name')->label(__('app.fields.method'))->placeholder('—'),
